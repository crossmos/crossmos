...
## :iphone:Контакты
[![Telegram](https://img.shields.io/badge/Telegram-blue?&logo=telegram&logoColor=white&style=for-the-badge&height=48)](https://t.me/Crossniros)  
...
- [FoundFoods](https://github.com/crossmos/FoundFoods)  
  Площадка для обмена рецептами. Вы можете опубликовать свои собственные рецепты, добавить любимые блюда в избранное и следить за новыми публикациями других авторов. У зарегистрированных пользователей есть возможность создавать списки покупок для приготовления выбранных блюд.
  <br/>
  <br/>
- [Homework_bot](https://github.com/crossmos/homework_bot)  
  Telegram-бот, который помогает отслеживать статус проекта отправленного на проверку на ЯндексПрактикуме. Бот отправляет запрос (requests) к API Яндекс Домашка, чтобы узнать статус.
  <br/>
  <br/>

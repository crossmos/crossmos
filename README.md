...
- [CarWallet](https://github.com/crossmos/CarWallet)
  API для учёта расходов на свои транспортные средства.<br/>
- [FoundFoods](https://github.com/crossmos/FoundFoods)
  Площадка для обмена рецептами. Вы можете опубликовать свои собственные рецепты, добавить любимые блюда в избранное и следить за новыми публикациями других авторов. У зарегистрированных пользователей есть возможность создавать списки покупок для приготовления выбранных блюд.<br/>
